...
Finally, when we show the results of a Horiuchi decomposition of sex differences in HLE, ULE, and total life expectancy, comparing results obtained when we calculate HLE using the Sullivan parameters of Fig~\ref{fig:sull_inputs} versus the parameters of Fig~\ref{fig:}
